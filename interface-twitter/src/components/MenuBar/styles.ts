...
import { AiOutlineHome, MdNotificationsNone, AiOutlineMail, MdFavoriteBorder, BsPersonFill, IoMdExit, Rocketseat } from '../../styles/Icons';
...
export const BellICon = styled(MdNotificationsNone)`
    ${iconCSS}
`;
